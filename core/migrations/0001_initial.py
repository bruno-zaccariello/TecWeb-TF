# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-26 20:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identificacao_turma', models.CharField(db_column='Identificacao_Turma', max_length=1)),
        ...
        migrations.AlterUniqueTogether(
            name='matricula',
            unique_together=set([('id_aluno', 'id_turma')]),
        ),
    ]
